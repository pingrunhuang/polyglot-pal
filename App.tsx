...
import { chatWithGemini, LANGUAGE_CONFIGS, resetSession } from './services/geminiService';
import { BookOpen, Coffee, Plane, Sparkles, AlertCircle, Globe2, ChevronRight, X, Terminal, ShieldAlert } from 'lucide-react';
  ...
  if (!selectedLanguage || !currentConfig) {
    return (
      <div className="flex flex-col h-[100dvh] bg-slate-50 font-sans relative">
        ...
        {errorMsg && <ErrorModal message={errorMsg} debugInfo={debugInfo || undefined} onClose={() => setErrorMsg(null)} />}
      </div>
    );
  }
